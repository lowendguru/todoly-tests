...
public class RandomValueGenerator {
	...
	public static Map<String, String> getUserBodyBasic() {

		String firstName = RandomValueGenerator.getRandomText(5);
		String lastName = RandomValueGenerator.getRandomText(6);
		String email = RandomValueGenerator.getRandomEmail();
